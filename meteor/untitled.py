...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rrc_taps = rrc_taps = 31
        self.rrc_alpha = rrc_alpha = 0.5
        self.pll_loop_bw = pll_loop_bw = 0.002
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.fir_filter_xxx_1 = filter.fir_filter_ccc(1, firdes.root_raised_cosine(1.0, samp_rate, sym_rate, rrc_alpha, rrc_taps))
        self.fir_filter_xxx_1.declare_sample_delay(0)
        self.digital_diff_decoder_bb_0 = digital.diff_decoder_bb(2, digital.DIFF_DIFFERENTIAL)
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(pll_loop_bw, 4, False)
        ...
        self.top_grid_layout.addWidget(self._ccsds_image_viewer_0_win, 0, 1, 3, 1)
        for r in range(0, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.ccsds_image_decoder_0 = CcsdsImageDecoder(65)
    ...
    def set_sym_rate(self, sym_rate):
        ...
        self.fir_filter_xxx_1.set_taps(firdes.root_raised_cosine(1.0, self.samp_rate, self.sym_rate, self.rrc_alpha, self.rrc_taps))
    ...
    def set_pll_loop_bw(self, pll_loop_bw):
        ...
        self.digital_costas_loop_cc_0.set_loop_bandwidth(self.pll_loop_bw)
